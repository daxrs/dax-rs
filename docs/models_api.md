...
description: "Inspect and edit model schema over REST — tables, columns, relationships, measures, and lineage."
weight: 5
icon: "verified_user"
...
Looking to run DAX queries? See the [DAX REST API](/docs/dax_api/).
